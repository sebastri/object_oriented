...
class SensorsRandom : public Sensors {
  public:
  SensorsRandom(string name, bool verbose = false): Sensors(name, verbose){}
  ~SensorsRandom() = default;
  Reading get_reading(unsigned long timestep, string name);
